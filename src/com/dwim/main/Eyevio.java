...
public class Eyevio {
	...
	public void config() {
		...
		ConfigMan.WRAPPER_SRR_SCRIPT = new String[] {"<span class=\"alttext\">¥¿¥¤¥È¥ë</span></div></td><td class=[^>]+>\\s*<div id=\"cclogo_layout\">\\s*<div class=[^>]+>([^<]+)</div>"};
	...
	public void crawlerTask() throws Exception {
		...
		Keyword firstWord = new Keyword(epset[0].getIthElement(0),"—ÊË÷");
